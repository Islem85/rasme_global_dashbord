...
# Pull all data once — wrapped defensively so a DB error never crashes the page
# before the sidebar has a chance to render.
try:
...
if _cov_ok:
    ...
    kpi_row([
              kpi_card(
                            ...
                            explainer=("Total des projets actifs suivis par RASME."
                                                              if lang == "FR" else
                                                              "Total active projects monitored by RASME."),
              ),
              kpi_card(
    ...
    kpi_row([
              ...
              kpi_card(
                            ...
                            icon="risk",
                            explainer=("Projets actifs sans monitoring interne."
                                                              if lang == "FR" else
                                                              "Active projects without internal monitoring."),
              ),
              kpi_card(
